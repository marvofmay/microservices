...
namespace App\User\Presentation\Request\SelectOption;
...
class ListingRequest
{
    public function __construct(
        ...
        $this->filters = array_filter($this->data, fn ($key) => in_array($key, SelectOption::getAttributes()), ARRAY_FILTER_USE_KEY);
