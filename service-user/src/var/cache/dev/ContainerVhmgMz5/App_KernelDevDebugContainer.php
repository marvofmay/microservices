...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\User\\Presentation\\API\\Address\\UserAddressesController' => 'getUserAddressesControllerService',
            'App\\User\\Presentation\\API\\SelectOptionKind\\CreateSelectOptionKindController' => 'getCreateSelectOptionKindControllerService',
            'App\\User\\Presentation\\API\\SelectOptionKind\\DeleteSelectOptionKindController' => 'getDeleteSelectOptionKindControllerService',
            'App\\User\\Presentation\\API\\SelectOptionKind\\ListSelectOptionKindController' => 'getListSelectOptionKindControllerService',
            'App\\User\\Presentation\\API\\SelectOptionKind\\RestoreDeletedSelectOptionKindController' => 'getRestoreDeletedSelectOptionKindControllerService',
            'App\\User\\Presentation\\API\\SelectOptionKind\\UpdateSelectOptionKindController' => 'getUpdateSelectOptionKindControllerService',
            'App\\User\\Presentation\\API\\SelectOption\\CreateSelectOptionController' => 'getCreateSelectOptionControllerService',
            'App\\User\\Presentation\\API\\SelectOption\\DeleteSelectOptionController' => 'getDeleteSelectOptionControllerService',
            'App\\User\\Presentation\\API\\SelectOption\\ListSelectOptionController' => 'getListSelectOptionControllerService',
            'App\\User\\Presentation\\API\\SelectOption\\ListSelectOptionKindController' => 'getListSelectOptionKindController2Service',
            'App\\User\\Presentation\\API\\SelectOption\\RestoreDeletedSelectOptionController' => 'getRestoreDeletedSelectOptionControllerService',
            'App\\User\\Presentation\\API\\SelectOption\\UpdateSelectOptionController' => 'getUpdateSelectOptionControllerService',
            'App\\User\\Presentation\\API\\User\\ChangeUserPasswordController' => 'getChangeUserPasswordControllerService',
            'App\\User\\Presentation\\API\\User\\CreateUserController' => 'getCreateUserControllerService',
            'App\\User\\Presentation\\API\\User\\DeleteUserController' => 'getDeleteUserControllerService',
            'App\\User\\Presentation\\API\\User\\ListUserController' => 'getListUserControllerService',
            'App\\User\\Presentation\\API\\User\\RegisterUserController' => 'getRegisterUserControllerService',
            'App\\User\\Presentation\\API\\User\\RestoreDeletedUserController' => 'getRestoreDeletedUserControllerService',
            'App\\User\\Presentation\\API\\User\\ShowUserController' => 'getShowUserControllerService',
            'App\\User\\Presentation\\API\\User\\ToggleActiveUserController' => 'getToggleActiveUserControllerService',
            'App\\User\\Presentation\\API\\User\\UpdateUserController' => 'getUpdateUserControllerService',
            'App\\User\\Presentation\\API\\User\\UploadUserAvatarController' => 'getUploadUserAvatarControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/prugala/symfony-request-dto/src/Serializer/Normalizer/CustomNormalizer.php';
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $c = ($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Entity'), (\dirname(__DIR__, 4).'/src/User/Domain/Entity')], true));

        $b->addDriver($c, 'App\\Entity');
        $b->addDriver($c, 'App\\User\\Domain\\Entity');

        $a->setEntityNamespaces(['App' => 'App\\User\\Domain\\Entity']);
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\User\\Domain\\Repository\\SelectOptionKind\\ReaderRepository\\SelectOptionKindReaderRepository' => ['privates', 'App\\User\\Domain\\Repository\\SelectOptionKind\\ReaderRepository\\SelectOptionKindReaderRepository', 'getSelectOptionKindReaderRepositoryService', true],
            'App\\User\\Domain\\Repository\\SelectOptionKind\\WriterRepository\\SelectOptionKindWriterRepository' => ['privates', 'App\\User\\Domain\\Repository\\SelectOptionKind\\WriterRepository\\SelectOptionKindWriterRepository', 'getSelectOptionKindWriterRepositoryService', true],
            'App\\User\\Domain\\Repository\\SelectOption\\ReaderRepository\\SelectOptionReaderRepository' => ['privates', 'App\\User\\Domain\\Repository\\SelectOption\\ReaderRepository\\SelectOptionReaderRepository', 'getSelectOptionReaderRepositoryService', true],
            'App\\User\\Domain\\Repository\\SelectOption\\WriterRepository\\SelectOptionWriterRepository' => ['privates', 'App\\User\\Domain\\Repository\\SelectOption\\WriterRepository\\SelectOptionWriterRepository', 'getSelectOptionWriterRepositoryService', true],
            'App\\User\\Domain\\Repository\\User\\ReaderRepository\\UserReaderRepository' => ['privates', 'App\\User\\Domain\\Repository\\User\\ReaderRepository\\UserReaderRepository', 'getUserReaderRepository2Service', true],
            'App\\User\\Domain\\Repository\\User\\WriterRepository\\UserWriterRepository' => ['privates', 'App\\User\\Domain\\Repository\\User\\WriterRepository\\UserWriterRepository', 'getUserWriterRepositoryService', true],
        ], [
            'App\\User\\Domain\\Repository\\SelectOptionKind\\ReaderRepository\\SelectOptionKindReaderRepository' => '?',
            'App\\User\\Domain\\Repository\\SelectOptionKind\\WriterRepository\\SelectOptionKindWriterRepository' => '?',
            'App\\User\\Domain\\Repository\\SelectOption\\ReaderRepository\\SelectOptionReaderRepository' => '?',
            'App\\User\\Domain\\Repository\\SelectOption\\WriterRepository\\SelectOptionWriterRepository' => '?',
            'App\\User\\Domain\\Repository\\User\\ReaderRepository\\UserReaderRepository' => '?',
            'App\\User\\Domain\\Repository\\User\\WriterRepository\\UserWriterRepository' => '?',
        ])));
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.exception', [#[\Closure(name: 'Prugala\\RequestDto\\EventListener\\RequestValidationExceptionListener')] fn () => ($container->privates['Prugala\\RequestDto\\EventListener\\RequestValidationExceptionListener'] ??= new \Prugala\RequestDto\EventListener\RequestValidationExceptionListener()), 'onKernelException'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        return $container->services['http_kernel'] = new \Symfony\Component\HttpKernel\HttpKernel(($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container)), new \Symfony\Component\HttpKernel\Controller\TraceableControllerResolver(new \Symfony\Bundle\FrameworkBundle\Controller\ControllerResolver($container, ($container->privates['monolog.logger.request'] ?? self::getMonolog_Logger_RequestService($container))), $a), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Symfony\Component\HttpKernel\Controller\TraceableArgumentResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory(), new RewindableGenerator(function () use ($container) {
            ...
            yield 8 => ($container->privates['.debug.value_resolver.Prugala\\RequestDto\\ArgumentResolver\\RequestDtoArgumentResolver'] ?? $container->load('getRequestDtoArgumentResolverService'));
            ...
            'Prugala\\RequestDto\\ArgumentResolver\\RequestDtoArgumentResolver' => ['privates', '.debug.value_resolver.Prugala\\RequestDto\\ArgumentResolver\\RequestDtoArgumentResolver', 'getRequestDtoArgumentResolverService', true],
    ...
    {
        return $container->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bfj7qvvhcA', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        $container->privates['monolog.handler.doctrine'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/doctrine.log'), 100, true, NULL, false);
    ...
    protected static function getSerializerService($container)
    {
        ...
        $e = new \Symfony\Component\Serializer\NameConverter\MetadataAwareNameConverter($b);

        return $container->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), new \Prugala\RequestDto\Serializer\Normalizer\CustomNormalizer($b, NULL, $a, $c, $d), new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $e), new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($b, $e, $c, $d, NULL)), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($b, $e, $a, $c, $d, NULL)], [new \Symfony\Component\Serializer\Encoder\XmlEncoder(), new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL), new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), new \Symfony\Component\Serializer\Encoder\CsvEncoder()]);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'RequestDtoBundle' => 'Prugala\\RequestDto\\RequestDtoBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'RequestDtoBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/prugala/symfony-request-dto/src'),
                    'namespace' => 'Prugala\\RequestDto',
                ],
            ],
