...
class getMessenger_Bus_Default_Middleware_SendMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['.service_locator.qpu31Pc'] ?? $container->load('get_ServiceLocator_Qpu31PcService'));
        ...
        $container->privates['messenger.bus.default.middleware.send_message'] = $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['App\\User\\Application\\Command\\User\\RegisterUserCommand' => ['rabbitmq_user_register']], $a), $b, true);
