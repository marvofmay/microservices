...
return [
    ...
    [ // $dynamicRoutes
        ...
        270 => [[['_route' => 'api.select-options.destroy', '_controller' => 'App\\User\\Presentation\\API\\SelectOption\\DeleteSelectOptionController::destroy'], ['uuid'], ['DELETE' => 0], null, false, true, null]],
        283 => [[['_route' => 'api.select-options-kinds.list', '_controller' => 'App\\User\\Presentation\\API\\SelectOption\\ListSelectOptionKindController::index'], [], ['GET' => 0], null, false, false, null]],
        319 => [[['_route' => 'api.select-options.restore_deleted', '_controller' => 'App\\User\\Presentation\\API\\SelectOption\\RestoreDeletedSelectOptionController::restoreDeleted'], ['uuid'], ['PATCH' => 0], null, false, false, null]],
        327 => [
            [['_route' => 'api.select-options.update', '_controller' => 'App\\User\\Presentation\\API\\SelectOption\\UpdateSelectOptionController::update'], ['uuid'], ['PUT' => 0], null, false, true, null],
