...
class getUserControllerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\User\\Presentation\\API\\UserController'] = $instance = new \App\User\Presentation\API\UserController(($container->privates['App\\User\\Presentation\\Validation\\User\\Register\\RegisterValidationRequest'] ?? $container->load('getRegisterValidationRequestService')), ($container->privates['App\\User\\Domain\\Action\\User\\RegisterUserAction'] ?? $container->load('getRegisterUserActionService')), ($container->privates['App\\User\\Domain\\Service\\ReaderService\\UserReaderService'] ?? $container->load('getUserReaderServiceService')), ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), ($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService')));
