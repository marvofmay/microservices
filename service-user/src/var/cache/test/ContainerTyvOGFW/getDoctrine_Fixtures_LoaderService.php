...
class getDoctrine_Fixtures_LoaderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addFixtures([['fixture' => ($container->privates['App\\DataFixtures\\AppFixtures'] ??= new \App\DataFixtures\AppFixtures()), 'groups' => []], ['fixture' => ($container->privates['App\\User\\Domain\\DataFixtures\\UserFixtures'] ?? $container->load('getUserFixturesService')), 'groups' => []]]);
